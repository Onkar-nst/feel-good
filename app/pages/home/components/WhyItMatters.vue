<template>
    <section class="pt-14 md:pt-16 lg:pt-20 pb-14 md:pb-16 lg:pb-20 relative bg-peach-soft overflow-hidden">

        <div class="absolute inset-0 -z-10 overflow-hidden" aria-hidden="true">
            <div class="aura animate-drift size-[32rem] -top-40 -end-32 bg-white/70"></div>
            <div class="aura animate-drift delay-2 size-80 bottom-0 -start-24 bg-primary-soft/60"></div>
        </div>
                ...
                <div class="lg:col-span-4">
                    <div class="flex flex-col lg:gap-20 md:gap-12 gap-10 h-full">
                        <div>
                            ...
                            <h2 class="h-display lg:text-5xl md:text-4xl text-3xl mb-8" data-reveal="up">
                            ...
                            <ul role="list" class="space-y-4" data-reveal-group>
                                <li v-for="(point, idx) in pointData" :key="idx"
                                    ...
                                    <span class="mt-0.5 flex size-6 shrink-0 items-center justify-center rounded-full bg-white/80 text-peach-ink transition-all duration-500 ease-soft group-hover:bg-primary group-hover:text-primary-ink group-hover:scale-110">
                        ...
                        <div class="mt-auto" data-reveal="up">
                            <div class="flex flex-wrap items-center justify-between gap-5 p-2 md:ps-7 rounded-2xl bg-white border border-peach/35 shadow-[0_18px_40px_-28px_rgb(14_59_62/0.45)]">
